...
plot_rle(rle_ship,"rle_ship")
```

It turns out the above beast dies shortly after its released. On the other hand, the spaceship below will be self-preserving and glide indefinitely:
...
We first convert its RLE into a tibble (one row per alive cell), and position it on the upper area of a 48x48 array:
