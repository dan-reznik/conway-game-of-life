...
```{r animate-rand,cache=T,eval=T,echo=F,fig.show='animate'}
...
```{r animate-glider,cache=T,eval=T,echo=F,fig.show='animate'}
# not working, requires ffmpeg
df_sim_glider %>% walk(~print(plot_df(.x)))
```
...
```{r animate-gun,cache=T,eval=T,echo=F,fig.show='animate'}
# not working, requires ffmpeg
